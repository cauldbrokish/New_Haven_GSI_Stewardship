...
# 1 read in data
## A GSI: City of New Haven
```{r}

list.files('../GSI STEWARDSHIP PROJECT/GSI STEWARDSHIP Project_data_too_big')

#stlayers is like list.files but for .gdb files
st_layers('../GSI STEWARDSHIP PROJECT/GSI STEWARDSHIP Project_data_too_big/50961b03-cb0b-49b9-a656-77d71bc30bbd.gdb')

inlet <- 
  st_read(  '../GSI STEWARDSHIP PROJECT/GSI STEWARDSHIP Project_data_too_big/50961b03-cb0b-49b9-a656-77d71bc30bbd.gdb'
          , 'inlet'
          , as_tibble = TRUE)
...
# I wonder why this graph looks so wonky. . .
recent_inspections |> 
  group_by(DEBRIS, Condition) |> 
  count() |> 
  ggplot(aes(DEBRIS, Condition)) +
  geom_col() +
  theme_bw(16) +
  NULL
