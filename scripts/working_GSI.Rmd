...
# 4.21 Trying to visualize the condition of Recent_Inspections by edit date using facet_wrap to visualize a third variable - NEEDS HELP
recent_inspections |> 
  group_by(EditDate, Condition) |> 
  ggplot(aes(n, Condition)) |> 
  geom_col() +
  theme_bw(16) + 
  facet_wrap(~EditDate, scales = 'free') + 
  NULL
